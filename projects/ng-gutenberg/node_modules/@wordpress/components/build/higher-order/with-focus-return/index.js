...
function withFocusReturn(options) {
  ...
  var _options$onFocusRetur = options.onFocusReturn,
      onFocusReturn = _options$onFocusRetur === void 0 ? _lodash.stubTrue : _options$onFocusRetur;
  return function (WrappedComponent) {
    var FocusReturn =
    /*#__PURE__*/
    function (_Component) {
      (0, _inherits2.default)(FocusReturn, _Component);

      function FocusReturn() {
        var _this;

        (0, _classCallCheck2.default)(this, FocusReturn);
        _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(FocusReturn).apply(this, arguments));
      ...
      (0, _createClass2.default)(FocusReturn, [{
        ...
        value: function componentWillUnmount() {
          ...
          var stack = [].concat((0, _toConsumableArray2.default)(_lodash.without.apply(void 0, [this.props.focus.focusHistory].concat((0, _toConsumableArray2.default)(ownFocusedElements)))), [activeElementOnMount]);
          var candidate;
        ...
        value: function render() {
          ...
          }, (0, _element.createElement)(WrappedComponent, this.props.childProps));
        }
      }]);
      return FocusReturn;
    }(_element.Component);
    ...
    return function (props) {
      return (0, _element.createElement)(_context.Consumer, null, function (context) {
        return (0, _element.createElement)(FocusReturn, {
          childProps: props,
          focus: context
        });
      });
...
var _default = (0, _compose.createHigherOrderComponent)(withFocusReturn, 'withFocusReturn');
