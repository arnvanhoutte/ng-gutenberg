  ...
  (0, _createClass2.default)(FormTokenField, [{
    ...
    value: function updateSuggestions() {
      ...
      if (inputHasMinimumChars) {
        ...
        var message = hasMatchingSuggestions ? (0, _i18n.sprintf)((0, _i18n._n)('%d result found, use up and down arrow keys to navigate.', '%d results found, use up and down arrow keys to navigate.', matchingSuggestions.length), matchingSuggestions.length) : (0, _i18n.__)('No results.');
