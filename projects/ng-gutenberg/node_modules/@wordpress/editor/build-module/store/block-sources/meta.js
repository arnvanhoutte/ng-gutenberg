...
var _marked =
/*#__PURE__*/
_regeneratorRuntime.mark(getDependencies),
    _marked2 =
/*#__PURE__*/
...
export function getDependencies() {
  return _regeneratorRuntime.wrap(function getDependencies$(_context) {
    while (1) {
...
export function apply(schema, _ref) {
  var meta = _ref.meta;
...
export function update(schema, value) {
  return _regeneratorRuntime.wrap(function update$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return editPost({
            meta: _defineProperty({}, schema.meta, value)
          });
