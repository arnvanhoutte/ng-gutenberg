...
function (_Component) {
  ...
  function WritingFlow() {
    ...
    _this.focusLastTextField = _this.focusLastTextField.bind((0, _assertThisInitialized2.default)(_this));
    /**
    ...
    _this.appender = (0, _element.createRef)();
    return _this;
  }
  ...
  (0, _createClass2.default)(WritingFlow, [{
    ...
    value: function onKeyDown(event) {
      ...
      if (isNavigationMode) {
        ...
        if (navigateDown && selectedBlockClientId && !selectionAfterEndClientId && [_keycodes.UP, _keycodes.DOWN].indexOf(keyCode) === -1) {
      ...
      if (!isVertical) {
        ...
        this.verticalRect = (0, _dom.computeCaretRect)();
