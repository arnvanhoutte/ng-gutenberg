 ...
 */
import { castArray, flatMap, first, get, includes, isArray, isBoolean, last, map, orderBy, reduce, some, find } from 'lodash';
...
import { SVG, Rect, G, Path } from '@wordpress/components'; // Module constants
...
export var getGlobalBlockCount = createSelector(function (state, blockName) {
  ...
  return reduce(clientIds, function (count, clientId) {
    var block = state.blocks.byClientId[clientId];
