...
exports.setInstallBlocksPermission = setInstallBlocksPermission;
exports.downloadBlock = downloadBlock;
exports.installBlock = installBlock;
exports.uninstallBlock = uninstallBlock;
...
var _marked =
/*#__PURE__*/
_regenerator.default.mark(downloadBlock),
    _marked2 =
/*#__PURE__*/
_regenerator.default.mark(installBlock),
    _marked3 =
/*#__PURE__*/
_regenerator.default.mark(uninstallBlock);
...
function downloadBlock(item, onSuccess, onError) {
  ...
  return _regenerator.default.wrap(function downloadBlock$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 3:
          _context.next = 5;
          return (0, _controls.loadAssets)(item.assets);

        case 5:
          registeredBlocks = (0, _blocks.getBlockTypes)();
...
function installBlock(_ref, onSuccess, onError) {
  ...
  return _regenerator.default.wrap(function installBlock$(_context2) {
    while (1) {
...
function uninstallBlock(_ref2, onSuccess, onError) {
  var id, name, response;
  return _regenerator.default.wrap(function uninstallBlock$(_context3) {
    while (1) {
