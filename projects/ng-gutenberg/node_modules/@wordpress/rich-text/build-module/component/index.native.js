...
var saferPasteHandler = function saferPasteHandler(originalPasteHandler, options) {
  try {
    ...
    return originalPasteHandler(_objectSpread({}, options, {
      HTML: ''
    }));
  }
};
...
function (_Component) {
  ...
  _createClass(RichText, [{
    ...
    value: function onSplit(record) {
      ...
      if (!hasPastedBlocks || !_isEmpty(before)) {
      ...
      if (hasPastedBlocks || !onSplitMiddle || !_isEmpty(after)) {
    ...
    value: function onEnter(event) {
      ...
      if (this.multilineTag) {
        if (event.shiftKey) {
          ...
          var insertedLineBreak = _objectSpread({}, insert(currentRecord, '\n'));
          ...
          var insertedLineSeparator = _objectSpread({}, insertLineSeparator(currentRecord));
        ...
        var _insertedLineBreak = _objectSpread({}, insert(currentRecord, '\n'));
    ...
    value: function onPaste(event) {
      ...
      if (typeof pastedContent === 'string') {
        ...
        var resultingRecord = insert(currentRecord, recordToInsert);
    ...
    value: function render() {
      ...
      var minHeight = styles['rich-text'].minHeight;

      if (style && style.minHeight) {
        minHeight = style.minHeight;
      }

      var defaultPlaceholderTextColor = styles['rich-text-placeholder'].color;
      var _styles$richText = styles['rich-text'],
