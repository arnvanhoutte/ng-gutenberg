...
function (_Component) {
  ...
  function RichText(_ref) {
    ...
    _this.valueToEditableHTML = _this.valueToEditableHTML.bind((0, _assertThisInitialized2.default)(_this));
  ...
  (0, _createClass2.default)(RichText, [{
    ...
    value: function onPaste(event) {
      ...
      if (onPaste) {
        ...
        var image = (0, _lodash.find)([].concat((0, _toConsumableArray2.default)(items), (0, _toConsumableArray2.default)(files)), function (_ref4) {
          var type = _ref4.type;
    ...
    value: function onFocus() {
      ...
      this.record = (0, _objectSpread2.default)({}, this.record, {
        start: index,
        end: index,
    ...
    value: function onSelectionChange(event) {
      ...
      var activeFormats = (0, _getActiveFormats.getActiveFormats)(newValue); // Update the value with the new active formats.
    ...
    value: function handleDelete(event) {
      ...
      if (multilineTag) {
        var newValue = (0, _removeLineSeparator.removeLineSeparator)(value, isReverse);
    ...
    value: function handleHorizontalNavigation(event) {
      ...
      if (newActiveFormatsLength !== activeFormats.length) {
        ...
        var _newValue = (0, _objectSpread2.default)({}, value, {
    ...
    value: function Editable(props) {
      ...
      var key = Tagname;
      return (0, _element.createElement)(_editable.default, (0, _extends2.default)({}, props, {
        tagName: Tagname,
        style: style,
        record: this.record,
        valueToEditableHTML: this.valueToEditableHTML,
        "aria-label": placeholder
      }, (0, _aria.pickAriaProps)(this.props), {
